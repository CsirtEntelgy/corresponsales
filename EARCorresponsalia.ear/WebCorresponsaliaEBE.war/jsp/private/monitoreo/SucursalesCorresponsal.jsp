<jsp:include page="../myHeader.jsp" flush="true">
	...
	<jsp:param name="menuSubitem" value="sucursalesCorresponsal" />
</jsp:include>
...
<script src="${pageContext.servletContext.contextPath}/js/private/monitoreo/SucursalesCorresponsal.js" type="text/javascript"></script>
...
<form id="formaLotesPorCompensar" action="" method="post">
	...
	<input type="hidden" id="compError" name="compError" value="Error en Sucursales Corresponsal"/>
	<input type="hidden" id="compAviso" name="compAviso" value="Aviso Sucursales Corresponsal"/>
				...
				<caption></caption>
					<tr>
						...
						<td>
							...
							onchange="javascript:formaLotesPorCompensar.action ='consultaSucCorresponsal.do';formaLotesPorCompensar.submit();">
