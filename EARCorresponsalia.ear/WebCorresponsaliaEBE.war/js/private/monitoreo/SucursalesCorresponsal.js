        ...
        if (file !== null && file !== "null") {
            if (file !== "") {
                ...
                jAlert('No se encontro el archivo.',   //DESCRIPCION ERROR
                    'Sucursales por Corresponsal',     //TITULO ERROR
                    '---',                             //CODIGO ERROR
...
function consultaSucursalesOperaciones() {
    if (document.getElementById("optCorresponsal1").value == 0) {
        ...
        llenaDatos();
        document.getElementById("operacion").value = "consultaSucCorresponsal";
        document.forms["formaLotesPorCompensar"].action = "consultaSucCorresponsal.do";
