...
import com.isban.corresponsalia.dao.consultas.DAOConsultaEstatusOperacionDLB5;
...
/**
 * Session Bean implementation class BOConsultasEstatusOperacionImp.
 */
@Stateless
@TransactionManagement(TransactionManagementType.BEAN)
public class BOConsultasEstatusOperacionImp extends ArchitechEBE implements
	BOConsultasEstatusOperacion {
	...
	@EJB
	transient private DAOConsultaEstatusOperacionDLB5 consultaDLB5BitacoraSinReferencia;
	...
	public RBeanCorresponsalesConsultaEstatusOperacion consultaCorresponsales(
		...
		final RBeanCorresponsalesConsultaEstatusOperacion rBeanCorresponsalesConsultaEstatusOperacion = new RBeanCorresponsalesConsultaEstatusOperacion();
		...
		rBeanCorresponsalesConsultaEstatusOperacion
				.setListaCorresponsales(listaCorresponsales);
		rBeanCorresponsalesConsultaEstatusOperacion.setCodError("BITA0000");
		rBeanCorresponsalesConsultaEstatusOperacion
				.setMsgError("Consulta de corresponsales regreso resultados");
		return rBeanCorresponsalesConsultaEstatusOperacion;
	}
