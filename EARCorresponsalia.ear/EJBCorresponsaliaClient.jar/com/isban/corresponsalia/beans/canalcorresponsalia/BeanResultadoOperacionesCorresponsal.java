...
/**
 * The Class BeanResultadoOperacionesCorresponsal.
 */
public class BeanResultadoOperacionesCorresponsal implements  BeanResultBO, Serializable{

	/** Operaciones Corresponsalia Catalogo. */
	...
	/** The Registros. */
	private List<BeanOperacion> Registros        = new ArrayList<BeanOperacion>();
	 ...
	 */
	public void setRegistros(List<BeanOperacion> pValue){
		Registros = pValue;
	}
	 ...
	 */
	public List<BeanOperacion> getRegistros(){
		return Registros;
	}
