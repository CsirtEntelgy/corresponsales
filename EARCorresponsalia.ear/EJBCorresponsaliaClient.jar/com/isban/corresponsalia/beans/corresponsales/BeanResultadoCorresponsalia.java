...
/**
 * The Class BeanResultadoCorresponsalia.
 */
public class BeanResultadoCorresponsalia implements  BeanResultBO, Serializable{
	...
	/** The Registros. */
	private ArrayList<BeanCorresponsal> Registros        = new ArrayList<BeanCorresponsal>();
	 ...
	 */
	public void setRegistros(ArrayList<BeanCorresponsal> pValue){
		Registros = pValue;
	}
	 ...
	 */
	public ArrayList<BeanCorresponsal> getRegistros(){
		return Registros;
	}
